...
function addToRoute(event) {
    if(routeTrips.length < 13) {
        ...
        appChild.querySelector('.content_card-shrunk').setAttribute('style', 'border-bottom:1px solid rgba(139, 93, 93, 0.28); border-left:0px solid rgba(139, 93, 93, 0.28); border-right:0px solid rgba(139, 93, 93, 0.28);');
        appChild.querySelector('.add-to-route-text').innerHTML = "Remove from Route";
        var newTrip = {
