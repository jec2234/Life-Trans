...
function timeEstimates (response, event = false) {
    ...
    if(event) {
        ...
        predictionTrips.querySelector('.pu-marker').innerHTML = alph.charAt((assTripEles.length * 2));
        predictionTrips.querySelector('.do-marker').innerHTML = alph.charAt((assTripEles.length * 2) + 1);
    }
}
